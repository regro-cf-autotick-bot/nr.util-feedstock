...
Once the `conda-forge` channel has been enabled, `nr.util` can be installed with:

```
conda install nr.util
```

It is possible to list all of the versions of `nr.util` available on your platform with:
